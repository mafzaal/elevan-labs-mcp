...
def get_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "default_voice_id": os.getenv("ELEVENLABS_DEFAULT_VOICE_ID", POPULAR_VOICES["george"]),
        "default_model_id": os.getenv("ELEVENLABS_DEFAULT_MODEL_ID", "eleven_multilingual_v2"),
        "default_output_format": os.getenv("ELEVENLABS_DEFAULT_OUTPUT_FORMAT", "mp3_44100_128"),
        ...
        "enable_logging": os.getenv("ELEVENLABS_ENABLE_LOGGING", "true").lower() == "true",
    }
...
def get_voice_by_name(name: str) -> str:
    ...
    raise ValueError(f"Voice '{name}' not found in popular voices. Available: {list(POPULAR_VOICES.keys())}")
